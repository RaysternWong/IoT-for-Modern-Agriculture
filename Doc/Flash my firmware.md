...
4. After uploaded, open the serial port monitor ( top right).
   ...
   So, if you board is working, then you are able to see a complete 1 cycle message as shown above. <hr/>(Ignore brightness control message, I did not implement it in openSource branch)
   
   If you did not see it, you may try another framework version, or [fully erase](http://www.pratikpanda.com/completely-format-erase-      esp8266-flash-memory/) your board <hr/> <i>(take note nodeMCU refer to esp8266-12E, is 4M memory device please erase with the instruction said)</i>

...
/*
  ...
  to known how to read data from water level sensor, take note that the sensor output is not directory proportional, 
  so you have to manually measure in multiple point by using analogRead(WATER_LEVEL_PIN)
*/
